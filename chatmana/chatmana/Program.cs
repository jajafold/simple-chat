...
static void AddChatData(WebApplication app)
{
    ...
    chatRepository.AddRoom("Server1", "Main1", "", 0);
    chatRepository.AddRoom("Server2", "Main2", "", 0);
    chatRepository.AddRoom("Server3", "Main3", "", 0);
    chatRepository.AddRoom("Server4", "Main4", "", 0);
}